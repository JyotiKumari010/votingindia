...
$get_votes_query = "SELECT id, encrypted_vote FROM votes WHERE is_counted = 0"; // Assuming `is_counted` is a column in `votes` table
    ...
    if ($result->num_rows == 0) {
       // echo "No uncounted votes found in votes table!<br>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Update vote count
            $update_query = "INSERT INTO votes_count (party_name, total_votes) VALUES ('$decrypted_vote', 1) ON DUPLICATE KEY UPDATE total_votes = total_votes + 1";
            ...
            if (!$conn->query($update_query)) {
                ...
                $mark_counted_query = "UPDATE votes SET is_counted = 1 WHERE id = $vote_id";
...
<div class="container">
    ...
    <header>
    <h3>General Parliamentary Result</h3>
...
<script>
                        ...
                        <?php
                        $partyQuery = "SELECT party_name, total_votes FROM votes_count";
