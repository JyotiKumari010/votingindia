...
$query = "SELECT party_name, total_votes FROM state_votes_count";
...
$totalVotesQuery = "SELECT SUM(total_votes) AS total_votes FROM state_votes_count";
...
$topCandidatesQuery = "SELECT party_name, votes FROM state_votes_count ORDER BY votes DESC LIMIT 1";
...
form button:hover {
    ...
    <div class="result-card">
        ...
        <?php
        // सबसे ज्यादा वोट पाने वाले को ढूंढें
