...
if (isset($_POST['add_election'])) {
    ...
    $sql = "INSERT INTO upcomingelection (ename, date, location, description ) VALUES ('$ename', '$date', '$location', '$description' )";
    $conn->query($sql);
}
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM upcomingelection WHERE id = $id";
    $conn->query($sql);
}
...
if (isset($_POST['update_election'])) {
    ...
    $sql = "UPDATE upcomingelection SET ename='$ename', date='$date', location='$location', description='$description'  WHERE id = $id";
    $conn->query($sql);
}

// Fetch all active elections
$election = $conn->query("SELECT * FROM upcomingelection");
?>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1>Admin Panel - Manage Upcoming Elections</h1>
            ...
            <div class="election-box">
                ...
                <table>
                    ...
                    <?php while ($row = $election->fetch_assoc()): ?>
                    <tr>
